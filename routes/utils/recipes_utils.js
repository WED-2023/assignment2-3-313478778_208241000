...
async function getRecipeDetails(recipe_id, full = false) {
    let recipe_info = await getRecipeInformation_search(recipe_id);
    let {
        id,
        title,
        readyInMinutes,
    ...
    try {
        ...
        const response = await axios.get(`${api_domain}/complexSearch`, {
            params: {
                ...
                number: cleanNumber,
                apiKey: process.env.SPOONACULAR_API_KEY.trim()
            }
        });
...
async function getRecipeInformation_search(recipe_id) {
